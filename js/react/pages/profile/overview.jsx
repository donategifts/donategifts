				...
				<div className="card-body">
					<div className="row justify-content-center">
						<div className="mb-2 col-12 d-flex">
							...
							<span className="mx-1">{agency.agencyName}</span>
							{agency.isVerified ? (
					...
					<div className="row justify-content-center my-4">
						...
						<div className="col-12 col-md-6">
							...
							<span id="agencyBio" className="mx-2">
								{new Date(agency.joined).toLocaleString().split(',')[0]}
							</span>
						</div>
					</div>
					<div className="row justify-content-center my-4">
						...
						<div className="col-12 col-md-6">
							...
							<span id="agencyWebsite" className="mx-2 text-wrap">
								{agency.agencyWebsite || 'Not provided'}
							</span>
						</div>
					</div>
		...
		<MantineProviderWrapper>
			<div id="profile">
				...
				<Container size="xl" className="pt-5">
					...
					{user.userRole == 'partner' && agency ? agencyDashboard() : null}
					{accountDetails()}
					{accountManagement()}
				</Container>
			</div>
