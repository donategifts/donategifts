  ...
  socketOptions = {
    handlePreflightRequest: (req, res) => {
      const headers = {
        ...
        'Access-Control-Allow-Origin': 'localhost:3000 127.0.0.1:3000 https://dev.donate-gifts.com:3000 https://donate-gifts.com:3000', // or the specific origin you want to give access to,
